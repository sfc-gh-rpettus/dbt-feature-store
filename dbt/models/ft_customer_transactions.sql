...
select
    ...
    {{ rolling_agg('TX_AMOUNT', 'CUSTOMER_ID', 'TX_DATETIME', '1 days', 'avg') }} as AVG_TX_AMOUNT_10D,
    {{ rolling_agg('TX_AMOUNT', 'CUSTOMER_ID', 'TX_DATETIME', '7 days', 'avg') }} as AVG_TX_AMOUNT_7D,
    {{ rolling_agg('TX_AMOUNT', 'CUSTOMER_ID', 'TX_DATETIME', '30 days', 'avg') }} as AVG_TX_AMOUNT_30D,
